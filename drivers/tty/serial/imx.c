...
// mod 4.4, because there function is not represented in android 6.0 kernel
// copy functions from android 4.4 kernel
/*
 ...
 */
int imx_uart_tx_empty(struct uart_port *uport)
{
	return imx_tx_empty(uport);
}
